...
class SlideFirePro_Widgets {
	...
	public function register_widget_assets() {
        ...
        // Register pants sizing guide assets
        wp_register_style(
            'slidefirePro-pants-sizing-guide',
            SLIDEFIREPRO_WIDGETS_URL . 'assets/css/pants-sizing-guide.css',
            [],
            '1.34.0'
        );
	...
	public function register_widgets( $widgets_manager ) {
		...
		require_once( __DIR__. '/widgets/class-pants-sizing-guide-widget.php' );
		...
		$widgets_manager->register( new Widgets\Pants_Sizing_Guide_Widget() );
	}
